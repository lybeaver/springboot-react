...
public class tUser {
     ...
     * @mbg.generated Mon Nov 05 13:52:23 CST 2018
     */
    public tUser(Long id, String name, String telephone, String sex, String loginName, String password, Date birthday, Date createTime, Date updateTime, Long createById, Long updateById, Long counts, String deleteFlg) {
        this.id = id;
        this.name = name;
